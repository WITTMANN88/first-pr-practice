...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> Ru = new()
    {
        ...
        ["TrayExit"] = "Выход",
        ["HomeTitle"] = "Главная",
        ["HomeSub"] = "Характеристики ПК, быстрые пресеты и очередь применения твиков по всем вкладкам.",
        ["HomePendingLabel"] = "Ожидают применения:",
        ["HomePendingListLabel"] = "Изменения в очереди",
        ["HomeSelectPresetBtn"] = "Выбрать",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["TrayExit"] = "Exit",
        ["HomeTitle"] = "Home",
        ["HomeSub"] = "PC specs, quick presets, and the real apply queue across all tabs.",
        ["HomePendingLabel"] = "Pending changes:",
        ["HomePendingListLabel"] = "Queued changes",
        ["HomeSelectPresetBtn"] = "Select",
        ["HomeApplyBtn"] = "Apply",
