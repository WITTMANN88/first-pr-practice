...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> Ru = new()
    {
        ...
        ["HomeRestorePointLabel"] = "Точка восстановления перед применением",
        ["HomeAvBannerTitle"] = "Возможна блокировка антивирусом",
        ["HomeAvBannerDesc"] = "Проба записи в реестр и в папку данных прошла с ограничениями — часть функций может не сработать.",
        ["HomeAvBannerBtn"] = "Открыть исключения Defender",
        ["SummaryTitle"] = "Сводка перед применением",
        ["SummaryConflictTitle"] = "Обнаружен конфликт",
        ["SummaryAckText"] = "Понимаю, в очереди есть рискованные и/или конфликтующие пункты, и хочу продолжить",
        ["SummaryCancel"] = "Отмена",
        ["SummaryConfirm"] = "Применить",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["HomeRestorePointLabel"] = "Create a restore point before applying",
        ["HomeAvBannerTitle"] = "Antivirus may be blocking Observation",
        ["HomeAvBannerDesc"] = "The registry/data-folder write probe ran into restrictions — some features may not work.",
        ["HomeAvBannerBtn"] = "Open Defender exclusions",
        ["SummaryTitle"] = "Summary before applying",
        ["SummaryConflictTitle"] = "Conflict detected",
        ["SummaryAckText"] = "I understand the queue has risky and/or conflicting items, and I want to continue",
        ["SummaryCancel"] = "Cancel",
        ["SummaryConfirm"] = "Apply",
        ["HomeApplyBtn"] = "Apply",
