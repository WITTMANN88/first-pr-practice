...
**Сейчас там заглушки `TODO: UPDATE_HASH`, поэтому установка ISLC и
MakuTweaker заблокирована**, пока не прописаны настоящие значения
(`Get-FileHash <файл> -Algorithm SHA256` по вручную скачанному и проверенному
установщику). При заглушке загрузка не начинается; при несовпадении лог
записывает ожидаемый и фактический хеш.
...
- Установка ISLC и MakuTweaker заблокирована до замены заглушек
  `TODO: UPDATE_HASH` настоящими SHA-256.
